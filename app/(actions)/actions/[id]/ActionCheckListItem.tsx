...
export default function ActionCheckListItem({ id, title, completed }: Props) {
  ...
  return (
    <div className="">
      ...
      <label
        htmlFor={uid}
        className="grid w-full grid-cols-[auto,1fr] gap-4 rounded border-2 border-slate-800 bg-white p-4 font-bold peer-checked:bg-slate-800 peer-checked:text-white peer-focus:border-blue-700"
      >
